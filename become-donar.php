...
background-image: linear-gradient(90deg, #3C8CE7 0%,  #00EAFF 100%);}
    .errorWrap {
    padding: 10px;
    margin: 0 0 20px 0;
    background: #fff;
...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3" style="color:white;">Become a <small>Donor</small></h1>
        ...
        <!-- Content Row -->
        <form name="donar" method="post" style="color:white;">
<div class="row">
