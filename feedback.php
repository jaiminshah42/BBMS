...
<head>
    ...
    <style>
        body{ background-color: #3C8CE7;
background-image: linear-gradient(90deg, #3C8CE7 0%,  #00EAFF 100%); color: white;}
    .errorWrap {
    padding: 10px;
    margin: 0 0 20px 0;
    background: #fff;
...
<body>
    ...
    <div class="container">
        ...
        <div class="container" >
            <!-- Map Column -->
              <div class="col-lg-9">
                <?php if($error){?><div class="errorWrap"><strong style="color: black;">ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
        else if($msg){?><div class="succWrap"><strong style="color: black;">SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
